...
const _routes = [
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/about-28c4878f.mjs').then((m) => m.default || m)
  },
  {
    name: "contact-us",
    path: "/contact-us",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/contact-us-ed4452ce.mjs').then((m) => m.default || m)
  },
  {
    name: "index",
    path: "/",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/index-60f41e84.mjs').then((m) => m.default || m)
  },
  {
    name: "profile",
    path: "/profile",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/profile-63a7a882.mjs').then((m) => m.default || m)
  }
];
...
const layouts = {
  default: () => import('./_nuxt/default-3b0b8001.mjs').then((m) => m.default || m)
};
...
const _sfc_main = {
  ...
  setup(__props) {
    const ErrorComponent = /* @__PURE__ */ defineAsyncComponent(() => import('./_nuxt/error-component-bba15cac.mjs').then((r) => r.default || r));
